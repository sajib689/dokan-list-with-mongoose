...
const ShopOwnerForm = () => {
  return (
    <form className="mb-24 mt-12 max-w-6xl mx-auto p-8 bg-white shadow-lg rounded-lg mt-8 space-y-6">
      <h2 className="text-3xl font-extrabold mb-12 text-start text-gray-900">Shop Owner Form</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div>
          <label className="block text-gray-600 font-semibold mb-2">Owner Name</label>
        ...
        <div>
          <label className="block text-gray-600 font-semibold mb-2">Owner Father Name</label>
        ...
        <div>
          <label className="block text-gray-600 font-semibold mb-2">Owner Mother Name</label>
        ...
        <div>
          <label className="block text-gray-600 font-semibold mb-2">Owner NID Number</label>
        ...
        <div>
          <label className="block text-gray-600 font-semibold mb-2">Owner Address</label>
        ...
        <div>
          <label className="block text-gray-600 font-semibold mb-2">Owner Blood Group</label>
        ...
        <div>
          <label className="block text-gray-600 font-semibold mb-2">Owner Duty</label>
          <div className="flex items-center">
            <input type="checkbox" name="ownerDuty" className="w-4 h-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
            <span className="ml-2 text-gray-700">On Duty</span>
          </div>
        </div>

        <div>
          <label className="block text-gray-600 font-semibold mb-2">Owner Phone Number</label>
        ...
        <div>
          <label className="block text-gray-600 font-semibold mb-2">Owner Photo</label>
        ...
        <div>
          <label className="block text-gray-600 font-semibold mb-2">Owner Shop Photo</label>
